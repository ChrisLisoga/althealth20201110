    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="index.php" class="navbar-brand" rel="tooltip" data-placement="bottom" target=""></a>
                        ...
                        <ul class="thumbnails">
                            ...
                            <div class="row-sm-3">
                                ...
                                <div class="caption">
                                  ...
                                  <h6><a class="btn btn-success btn-round" title="Click for more details!" href="pages/product_details.php?product_id=<?php echo $res['product_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-right">R<?php echo $res['product_price']; ?></medium></h6>
                                </div>
