<?php
    ...
    if (isset($_SESSION['id'])){
        header('Locategoryion:user_index.php');
    }
?>
...
<body class="login-page sidebar-collapse">
        ...
        <div class="container">
            <div class="navbar-transactionslate">
                <a href="../index.php" class="navbar-brand" rel="tooltip" ,data-placement="bottom">
                  <img src="assets/img/altHealth.jpeg" alt="Althealth" height="100px" style="left:0;" id="logo">
                </a>
    ...
    <div class="page-header" filter-color="white">
        <div class="page-header-image" style="background-image:url(assets/img/background.jpeg)"></div>
        <div class="container">
            <div class="col-md-4 content-center">
                <div class="card card-login card-plain">
                    <form class="form" method="POST" action="pages/user_login.php">
