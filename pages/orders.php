    ...
    <div class="wrapper"><br>
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                      <h2>Customer Cart</h2>
                      <a class="btn btn-primary btn-round" href="supplements.php"><i class="now-ui-icons arrows-1_minimal-left"></i> &nbsp Back to index</a>
                      <hr color="orange"> 
                ...
                <div class="panel panel-success panel-size-customerom">
                        <div class="panel-body">
								...
								<?php
                                      ...
                                      $query = "SELECT * FROM ecommercedb.order ORDER BY order_date ASC";
