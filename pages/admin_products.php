                                          ...
                                          if($result){
                                            while($res = mysqli_fetch_array($result)) {     
                                              echo "<tr>";
                                                ...
                                                ?>
                                                 <td><span style="color:red;"><?php echo $res['product_quantity'];?> : Reorder!</span></td>  
                                                 <?php
                                                }else{
                                               ?>
                                               ...
                                               <?php }
                                                ...
                                                echo "<td><a href=\"admin_product_details.php?product_id=$res[product_id]\">View</a></td>";
                                              echo "</tr>"; 
                                            }
                                          }?>
                                </table><br><br><br><br>
