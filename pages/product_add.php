...
if(isset($_POST['submit'])){
    ...
    if(empty($product_name) || empty($description) || empty($product_quantity) || empty($product_cost) || empty($product_price) || empty($category) 
        || empty($supplier) || empty($product_serial) || empty($product_image1) || empty($product_image2) || empty($product_image3)){    
        ...
        $query = "INSERT INTO products (product_name, description, product_quantity, product_cost, product_price, category, supplier, product_serial, product_image1, product_image2, product_image3) 
        VALUES ('$product_name','$description','$product_quantity','$product_cost','$product_price','$category','$supplier','$product_serial','$product_image1','$product_image2','$product_image3')";  
        ...
        if($result){
            ...
            $query=mysqli_query($dbconn,"SELECT product_name FROM products WHERE product_id='$product_name'")or die(mysqli_error());
          
                $row=mysqli_fetch_array($query);
                $product=$row['product_name'];
                $remarks="added a new product $product_quantity of $product_name";  
          ...
          <div class="panel-body">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form group">
                    ...
                    <label for="product_cost">Product Cost (R):</label>
                    <input type="text" class="form-control" id="product_cost" name="product_cost" placeholder="Value e.g. 123.4"/>
                    <label for="product_price">Product Price (R):</label>
                    <input type="text" class="form-control" id="product_price" name="product_price" placeholder="Value e.g. 123.4"/>
                    <label for="product_quantity">Quantity:</label>
                    <input type="text" class="form-control" id="product_quantity" name="product_quantity" placeholder="Value e.g. 123"/>
                    ...
                    <div class="form-group">
                        ...
                        <label for="product_image1">Picture 1 (Front View):</label>
                        <div class="input-group">
                            <input type="file" class="form-control" id="product_image1" name="product_image1">  
                        </div>
                        <label for="product_image2">Picture 2 (Side View):</label>
                        <div class="input-group">
                            <input type="file" class="form-control" id="product_image2" name="product_image2">  
                        </div>
                        <label for="product_image3">Picture 3 (Specificategoryions):</label>
                        <div class="input-group">
                    ...
                    <label for="product_serial">Serial:</label>
                    <input type="text" class="form-control" id="product_serial" name="product_serial" placeholder="Value e.g. 1234"/>
