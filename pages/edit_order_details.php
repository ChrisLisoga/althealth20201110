...
<?php
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $total = $_POST['product_quantity']*$_POST['total'];

                                        date_default_timezone_set('Asia/Manila');
                                        $date = date("Y-m-d H:i:s");      

                         mysqli_query($dbconn,"UPDATE order_details SET
                          product_quantity='$product_quantity',total='$total' WHERE order_details_id='$order_id'") 
                     or die(mysqli_error());
                                            ?>
...
<form method="post">
  ...
  <table class="table table-bordered table-condensed">
        ...
        <tr>
                  ...
                  <td> <img width="150" height="100" src="../uploads/<?php echo $row2['product_image1'];?>" alt=""/></td>
                  <td><b><?php echo $row2['product_name'];?></b><br><br>
                          <?php $string=$row2['description'];?></td>
          <td>
      <div class="input-append">
      <?php
  echo "<select class='btn btn-warning btn-round dropdown-toggle' size='1' name='product_quantity' id='product_quantity'>";
$i=1; $product_quantity=$product_quantity;
...
?>
              ...
              <input type="hidden" name="total" value="<?php echo $row2['product_price'];?>">
                </tr>
