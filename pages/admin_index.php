        ...
        <div class="container">
            <div class="navbar-transactionslate">
                <a href="admin_panel.php" class="navbar-brand" rel="tooltip" data-placement="bottom" target="">
                    <img src="assets/img/logo.png" alt="Elegant Me" height="100px" style="left:0;" id="logo">
                </a>
                    ...
                    ?>   
                        <div class="row-sm-3">
                            ...
                            <div class="caption">
                              ...
                              <h6><a class="btn btn-success btn-round" title="Click for more details!" href="admin_product_details.php?product_id=<?php echo $res['product_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-right">Php<?php echo $res['product_price']; ?></medium></h6>
                            </div>
