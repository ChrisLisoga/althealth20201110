...
<body class="index-page sidebar-collapse">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="../assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="user_product.php">
    ...
    <div class="wrapper">
        <div class="page-header clear-filter" filter-color="orange">
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/image2.png');">
        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                    <br>
                    <div class="col-md-12">
                        <h2 class="title">ElegantMe' products</h2>
                        <div class="typography-line">
                            <p>
                            “The reason it seems that price is all your customeromers care about is that you haven’t given them anything else to care about.”-Seth Godin, American author, entrepreneur, marketer, and public speaker.
                            </p>
                        </div>
                        <br>
                    ...
                    <div class="tab-pane  active" id="">
                        <ul class="thumbnails">
                            ...
                            $query="SELECT * FROM products WHERE category LIKE '%$search%' OR product_name LIKE '%$search%' OR description LIKE '%$search%'";
                            ...
                            <div class="row-sm-3">
                                <div class="thumbnail">
                                    <?php if($res['product_image1'] != ""): ?>
                                    <img src="../uploads/<?php echo $res['product_image1']; ?>" width="300px" height="200px">
                                    <?php else: ?>
                                    <img src="../uploads/default.png" width="300px" height="200px">
                                    <?php endif; ?>
                                <div class="caption">
                                  <h5><b><?php echo $res['product_name'];?></b></h5>
                                  <h6><a class="btn btn-success btn-round" title="Click for more details!" href="user_product_details.php?product_id=<?php echo $res['product_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-right">Php<?php echo $res['product_price']; ?></medium></h6>
                                </div>
...
<script type="text/javascript">
   ...
   <!---  inserted  -->
    ...
    <script src="../assets/js/applicategoryion.js"></script>
    <script src="../assets/js/bootstrap-transactionsition.js"></script>
